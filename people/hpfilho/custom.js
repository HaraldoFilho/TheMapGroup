function custom() {
  ...
  document.title = member_info["name"].concat(" | Photos Map");
  ...
  member_link.setAttribute("href", member_info["url"]);
  ...
  document.getElementById("n-markers").innerText = member_info["markers"];
  document.getElementById("n-photos").innerText = member_info["photos"];
