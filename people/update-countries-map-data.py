...
for country_code in countries_dict:
    if country_code in members_dict:
        members_dict[country_code].append([user_info["id"], countries_dict[country_code][1], countries_dict[country_code][2]])
    else:
        members_dict[country_code] = [[user_info["id"], countries_dict[country_code][1], countries_dict[country_code][2]]]
